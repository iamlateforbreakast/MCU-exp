...
Wire DIN to GPIO19, CLK to GPIO18, CS to GPIO17, DC to GPIO20, RST to GPIO21, BUSY to
GPIO22, plus **3.3V only** (5V will damage the panel, per WeAct's own module docs) and
